...
def processRequest(req):
    ...
    yql_url = "http://ws.audioscrobbler.com/2.0/?method=artist.gettoptracks&artist="+req.reuslt.parameters.Artist+"&api_key=c68de8a6159c02cd683804aa40debc53&format=json"
